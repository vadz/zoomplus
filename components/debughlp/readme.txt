Written by Russ Freeman Copyright ©1998.
...
* Write all TRACE messages to a TSV log file
...
The files belong wholly to Russ Freeman.
...
History
=======
* Fixed bug where VAPI would now output the correct error when the log file had been set.
